...
const icons = [<HomeIcon />, <AccountCircleIcon />, <AddBoxIcon />];

const routes = [
  "/admin/dashboard",
  "/admin/dashboard/about",
  "/admin/dashboard/newdeals",
  "/admin/dashboard/personinfo",
];
        ...
        <Typography paragraph>
          <div>
            ...
            <div className="homepage-container">
              <div
                onClick={() => history.push("/admin/dashboard/personinfo")}
                style={{
